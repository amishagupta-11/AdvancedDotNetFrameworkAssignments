using AdvanceDataAccessSamples.Models;
using Microsoft.AspNetCore.Mvc;
using Microsoft.Data.SqlClient;

namespace AdvanceDataAccessSamples.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class ADOSamplesController : ControllerBase
    {
        private readonly IConfiguration Configuration;

        public ADOSamplesController(IConfiguration configuration)
        {
